...
public class ListagemEtapa01 {
	...
	public static void ListagemDeArquivos( String grupo) {
		...
		do {
			...
			case 1: 
				...
				System.out.println("Você escolheu o Cliente 01 do " + grupo + " e esses são seus arquivos: \n");
			...
			case 2: 
				...
				System.out.println("Você escolheu o Cliente 02 do " + grupo + " e esses são seus arquivos: \n");
			...
			case 3: 
				...
				System.out.println("Você escolheu o Cliente 03 do " + grupo + " e esses são seus arquivos: \n");
